...
model = Model()
model.init_from_bin("llama", "ne_llama_q.bin",
                    num_beams=1, max_new_tokens=512, ctx_size = 512, do_sample=True, temperature=0.001, top_p=0.95, top_k=1, threads=28, repetition_penalty=1.0)
