...
from intel_extension_for_transformers.transformers.ppo_core import LengthSampler, set_seed
...
from intel_extension_for_transformers.transformers.modeling.trl_models import AutoModelForCausalLMWithValueHead
...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained(script_args.tokenizer_name, token=script_args.hf_access_token)
    ...
    sentiment_pipe = pipeline(
        ...
        device=device,
        model_kwargs={"use_auth_token":script_args.hf_access_token},
    )
